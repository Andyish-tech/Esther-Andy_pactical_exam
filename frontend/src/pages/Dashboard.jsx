        ...
        <main className="p-4 sm:p-6 lg:p-8 flex-1 overflow-y-auto max-w-7xl w-full mx-auto">
          {loading ? (
            <div className="h-[60vh] flex flex-col items-center justify-center gap-4">
              ...
              <p className="text-gray-500 font-semibold animate-pulse">Synchronizing database tables...</p>
            </div>
          ) : (
      ...
      <div className="space-y-8 text-left">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="glass-card p-6 rounded-2xl flex items-center gap-5">
            <div className="w-12 h-12 rounded-xl bg-gray-100 border border-gray-300 flex items-center justify-center text-black shrink-0">
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
              </svg>
            </div>
            <div>
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Fleet Registered</p>
              <h3 className="text-2xl font-black mt-1 text-black">{totalCars} Vehicles</h3>
            </div>
          </div>
          ...
          <div className="glass-card p-6 rounded-2xl flex items-center gap-5">
            ...
            <div>
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Services Cataloged</p>
              <h3 className="text-2xl font-black mt-1 text-black">{totalServices} Standard Jobs</h3>
            </div>
          </div>
          ...
          <div className="glass-card p-6 rounded-2xl flex items-center gap-5">
            ...
            <div>
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Service Jobs Completed</p>
              <h3 className="text-2xl font-black mt-1 text-black">{totalRecords} Completed</h3>
            </div>
          </div>
        ...
        <div className="glass-card p-6 rounded-2xl">
          <h3 className="text-lg font-bold mb-4 text-black">Quick System Actions</h3>
          <div className="flex flex-wrap gap-4">
            <button
              ...
              className="px-5 py-3 rounded-xl font-bold bg-black hover:bg-[#a1a1aa] text-white text-sm flex items-center gap-2 transition-all duration-200 hover:scale-[1.02]"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {user.role === 'admin' && (
              <button
                ...
                className="px-5 py-3 rounded-xl font-bold bg-white hover:bg-gray-100 border border-black hover:border-gray-400 text-black text-sm flex items-center gap-2 transition-all duration-200 hover:scale-[1.02]"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="glass-card rounded-2xl p-6 overflow-hidden">
            <div className="flex justify-between items-center mb-5">
              <h3 className="text-lg font-bold text-black">Recent Fleet Additions</h3>
              <button onClick={() => setActiveTab('cars')} className="text-gray-500 hover:text-[#a1a1aa] font-semibold text-xs transition-all hover:underline">
                View All Cars
              </button>
            </div>
            {cars.length === 0 ? (
              <p className="text-sm text-gray-500 py-6 text-center">No vehicles registered yet.</p>
            ) : (
                ...
                <table className="w-full text-left text-sm border-collapse">
                  ...
                  <tbody>
                    {cars.slice(-4).reverse().map((car) => (
                      <tr key={car.platenumber} className="border-b border-gray-100 hover:bg-gray-50 text-black">
                        <td className="py-3.5 font-mono text-xs font-bold text-black uppercase">{car.platenumber}</td>
                        <td className="py-3.5">
                          <div>
                            <p className="font-bold text-black">{car.type}</p>
                            <p className="text-xs text-gray-500">{car.model} ({car.manufacturing_year})</p>
                          </div>
                        </td>
                        <td className="py-3.5 text-xs font-semibold text-gray-500 capitalize">{car.mechanicName}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div className="glass-card rounded-2xl p-6 overflow-hidden">
            <div className="flex justify-between items-center mb-5">
              <h3 className="text-lg font-bold text-black">Recent Payments Log</h3>
              <button onClick={() => setActiveTab('payments')} className="text-gray-500 hover:text-[#a1a1aa] font-semibold text-xs transition-all hover:underline">
                View Payments
              </button>
            </div>
            {payments.length === 0 ? (
              <p className="text-sm text-gray-500 py-6 text-center">No payment entries registered.</p>
            ) : (
              <div className="overflow-x-auto">
                <table className="w-full text-left text-sm border-collapse">
                  <thead>
      ...
      <div className="space-y-6 text-left">
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          ...
          <button
            ...
            className="w-full sm:w-auto px-5 py-3 rounded-xl font-bold bg-black hover:bg-[#a1a1aa] text-white text-sm flex items-center justify-center gap-2 transition-all duration-200 shrink-0 hover:scale-[1.02]"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            </svg>
        ...
        <div className="glass-card rounded-2xl overflow-hidden">
          {filteredCars.length === 0 ? (
            <div className="py-12 text-center text-gray-500">
              ...
              <p className="font-semibold text-gray-600">No matching vehicles found</p>
              <p className="text-xs text-gray-400 mt-1">Try refining your search filter.</p>
            </div>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm border-collapse">
                ...
                <tbody>
                  {filteredCars.map((car) => (
                    <tr key={car.platenumber} className="border-b border-gray-100 hover:bg-gray-50 text-black transition-colors">
                      <td className="px-6 py-4 font-mono font-extrabold text-black uppercase tracking-wide">{car.platenumber}</td>
                      <td className="px-6 py-4 font-bold text-black">
                        {car.type} <span className="font-normal text-gray-500 ml-1">{car.model}</span>
                      </td>
                      <td className="px-6 py-4 text-gray-500 text-xs font-mono">{car.manufacturing_year || 'N/A'}</td>
                      <td className="px-6 py-4 font-semibold text-black capitalize">{car.mechanicName}</td>
                      <td className="px-6 py-4 font-mono text-gray-500 text-xs">{car.driverPhone || 'Not logged'}</td>
                      <td className="px-6 py-4 text-right">
                        <div className="flex justify-end gap-2.5">
                          <button
                            onClick={() => openEditCar(car)}
                            className="p-2 rounded-lg bg-white hover:bg-gray-100 border border-black hover:border-[#a1a1aa] text-gray-500 hover:text-[#a1a1aa] transition-all"
                          ...
                          {user.role === 'admin' ? (
                            ...
                            <span className="p-2 text-gray-300 cursor-not-allowed" title="Admin access only">
                              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((srv) => (
            <div key={srv.serviceCode} className="glass-card p-6 rounded-2xl flex flex-col justify-between glass-card-hover relative overflow-hidden">
              <div className="absolute top-0 right-0 w-24 h-24 bg-gray-100 rounded-full blur-xl pointer-events-none"></div>
              
              <div>
                <div className="flex justify-between items-start mb-4">
                  <span className="font-mono text-xs font-bold text-black uppercase bg-gray-100 px-2.5 py-1 rounded-md border border-gray-300">
                    {srv.serviceCode}
                  </span>
                  ...
                  {user.role === 'admin' && (
                    <div className="flex gap-1.5">
                      <button
                        ...
                        className="p-1.5 rounded-lg hover:bg-gray-100 text-gray-500 hover:text-[#a1a1aa] transition-colors"
                ...
                <h3 className="text-lg font-bold text-black mb-2 max-w-[85%]">{srv.servicename}</h3>
          ...
          {services.length === 0 && (
            <div className="col-span-full py-12 text-center text-gray-500 glass-card rounded-2xl">
              <p className="font-semibold text-gray-600">Service catalog is empty</p>
              <p className="text-xs text-gray-400 mt-1">Please register new service classes.</p>
            </div>
          )}
        </div>
      </div>
    ...
    return (
      <div className="space-y-6 text-left">
        ...
        <div className="glass-card rounded-2xl overflow-hidden">
          {records.length === 0 ? (
            <div className="py-12 text-center text-gray-500">
              <p className="font-semibold text-gray-600">No service records registered</p>
              <p className="text-xs text-gray-400 mt-1">Click above to log service records for registered cars.</p>
            </div>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm border-collapse">
                ...
                <tbody>
                  {records.map((rec) => (
                    <tr key={rec.recordnumber} className="border-b border-gray-100 hover:bg-gray-50 text-black transition-colors">
                      <td className="px-6 py-4 font-mono text-xs font-bold text-gray-500">#{rec.recordnumber}</td>
                      <td className="px-6 py-4 font-mono font-bold text-black uppercase">{rec.platenumber}</td>
                      <td className="px-6 py-4 font-bold text-black">
                      ...
                      <td className="px-6 py-4 text-right">
                        {user.role === 'admin' ? (
                          ...
                          <span className="text-gray-400 text-xs font-semibold px-2 py-1 bg-gray-100 border border-gray-300 rounded-md">
                            Read Only
                          </span>
                        )}
                      </td>
    ...
    return (
      <div className="space-y-6 text-left">
        ...
        <div className="glass-card rounded-2xl overflow-hidden">
          {payments.length === 0 ? (
            <div className="py-12 text-center text-gray-500">
              <p className="font-semibold text-gray-600">No payment receipts found</p>
              <p className="text-xs text-gray-400 mt-1">Receipt entries will pop up here once registered.</p>
            </div>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm border-collapse">
                ...
                <tbody>
                  {payments.map((pay) => (
                    <tr key={pay.paymentnumber} className="border-b border-gray-100 hover:bg-gray-50 text-black transition-colors">
                      <td className="px-6 py-4 font-mono text-xs font-bold text-gray-500">#{pay.paymentnumber}</td>
                      <td className="px-6 py-4 text-gray-500 text-xs">
        ...
        <div className="w-full max-w-lg glass-card rounded-2xl p-6 text-left relative overflow-hidden">
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="p-1 rounded-lg text-gray-500 hover:text-black transition-colors"
            >
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <form onSubmit={handleCarSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-1.5">Manufacture Year</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-1.5">Model Name</label>
                <input
                  type="text"
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-1.5">Mechanic Assigned</label>
              <input
                type="text"
            ...
            {carModal.mode === 'edit' && (
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-1.5">Driver Contact Phone</label>
                <input
                  type="text"
            ...
            <button
              type="submit"
              className="w-full py-3 rounded-xl font-bold bg-black hover:bg-[#a1a1aa] text-white text-sm active:scale-[0.98] transition-all duration-200 mt-4"
            >
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 backdrop-blur-sm animate-fade-in">
        <div className="w-full max-w-md glass-card rounded-2xl p-6 text-left relative overflow-hidden">
          ...
          <form onSubmit={handleServiceSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-1.5">Service Code</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-1.5">Service Task Name</label>
              <input
                type="text"
  ...
  function renderRecordModal() {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 backdrop-blur-sm animate-fade-in">
        <div className="w-full max-w-md glass-card rounded-2xl p-6 text-left relative overflow-hidden">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-bold text-black">Log Vehicle Service Job</h3>
            <button
          ...
          <form onSubmit={handleRecordSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-1.5">Select Vehicle (Plate)</label>
              <select
                ...
                required
              >
                <option value="" className="bg-white">-- Choose registered car --</option>
                {cars.map(car => (
                  <option key={car.platenumber} value={car.platenumber} className="bg-white">
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-1.5">Select Service Class</label>
              <select
  ...
  function renderPaymentModal() {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30 backdrop-blur-sm animate-fade-in">
        <div className="w-full max-w-md glass-card rounded-2xl p-6 text-left relative overflow-hidden">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-bold text-black">Record Invoice Payment</h3>
            <button
